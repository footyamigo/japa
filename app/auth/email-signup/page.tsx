...
import { signUp, SignUpData } from '@/lib/services/firebase';
...
export default function EmailSignUpPage() {
  ...
  const handleSignUp = async () => {
    ...
    setError('');
    try {
      await signUp({ name, email, password } as SignUpData);
    ...
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="flex-[0.5] bg-white rounded-t-[30px] -mt-10 overflow-y-auto">
        <div className="px-8 pt-8 pb-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-black mb-2">Sign up with Email</h1>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-center mt-6">
              ...
              <button onClick={() => router.push('/auth/email-login')} className="text-indigo-600 font-bold ml-1">
                Sign In
              </button>
            </div>
          </div>
